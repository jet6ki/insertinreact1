...
const AddBook = () => {
  ...
  const [book, setBook] = useState({ title: "", author: "", description: "", coverUrl: "" });
  ...
  return (
    <div className="add-book-container">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <input type="url" name="coverUrl" placeholder="Cover Image URL" value={book.coverUrl} onChange={handleChange} required />
